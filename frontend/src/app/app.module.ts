...
import { ProfileAuthorityComponent } from './components/local-authority/profile-authority/profile-authority.component';
...
const appRoutes: Routes = [
  ...
  { path: 'profileAuthority', component: ProfileAuthorityComponent},
];
