...
//  public Initiative(int id, String city, String collaboration, Date date, String goalCreate, String gaolFootprint, String gaolGreen, String gaolImprove, String gaolReduce, String gridExpertise1, String gridExpertise2, String gridExpertise3, String gridRadios, String gridRadios2, String gridRadios3, String gridRadios4, String inputEmail, int inputPhone, String inputWebsite, String name, String selectedTheme, String state, String zip) {
//    this.id = id;
//    this.city = city;
